...
CREATE TABLE `living_room` (
  ...
  PRIMARY KEY (`room_id`),
  KEY `living_room_ibfk_1` (`home_id`),
  CONSTRAINT `living_room_ibfk_1` FOREIGN KEY (`home_id`) REFERENCES `home` (`home_id`) ON DELETE CASCADE
...
-- Dump completed on 2024-11-28 23:21:14
